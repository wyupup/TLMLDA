...
from ziyu_mmd_emotion import lmmd_emotion
...
def train(epoch, model):
    ...
    for i in range(0, num_iter):       
        ...
        loss_lmmd = lmmd_emotion(s_dnn_out, t_dnn_out, s_label, t_label) 
        ...
        loss = 0.1*loss1 + 0.1*loss2 + 5*loss_cls + 2*loss_mmd + 0.1*loss_lmmd 
        train_loss += loss
